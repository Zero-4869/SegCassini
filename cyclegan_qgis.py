...
params["prev_iter"] = 0
params["save_dir"] = "model_weights/cyclegan/epure2_align_blur_mu3_mask_full_l3_bias_BN_GN2"
...
params["figure_savedir"] = "fig_results/cyclegan/epure2_align_blur_mu3_mask_full_l3_bias_BN_GN2"
...
params["log_dir"] = "logs/cyclegan/epure2_align_blur_mu3_mask_full_l3_bias_BN_GN2.txt"
params["do_tensorboard"] = False
params["tb_dir"] = "tb/epure2_align_blur_mu3_mask_full_l3_bias_BN_GN2"
...
def train(params, train_dataloader, val_dataloader, eval_only=False):
    ...
    for n in tqdm(range(params["prev_iter"], params["prev_iter"]+params["niter"])):
        ...
        if (n+1) % params["eval_epoch_freq"] == 0:
            ...
            total_g_loss, total_d_loss, total_align_loss, total_p_loss, total_closs = evaluate(params, val_dataloader, model_G12, model_G21, model_D1, model_D2, params["plot_figure"], n)
            print(
...
def evaluate(params, dataloader, model_G12, model_G21, model_D1, model_D2, is_plot, epoch = 0):
    model_G12.eval()
    model_G21.eval()
    model_D1.eval()
    model_D2.eval()
        ...
        for images1, images2, masks1 in dataloader:
            ...
            if is_plot and count < 100:
                ...
                for i in range(len(images1)):
                    ...
                    image_list = [images1[i], images2[i], gen12[i], gen21[i], gen1[i], gen2[i]]
                    mask_list = [masks1[i]]
