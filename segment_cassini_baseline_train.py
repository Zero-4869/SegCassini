...
def argparser():
    ...
    parser.add_argument("--cassini", type=str, default="patchdata2/Cassini_seg", help="directory to cassini dataset")
    parser.add_argument("--gt", type=str, default="patchdata2/epure_multilayers_seg_wbg", help="directory to pesudo Ground truth dataset")
    parser.add_argument("--model_savedir", type=str, default="model_weights/seg/seg_cassini")
    parser.add_argument("--fig_savedir", type=str, default="fig_results/seg/seg_cassini")
    parser.add_argument("--log_dir", type=str, default="logs/seg/seg_cassini.txt")
    parser.add_argument("--tb_dir", type=str, default="tb/seg/seg_cassini")
...
def main(args):
    ...
    train_set = SegDataset_Train(
        os.path.join(args.cassini, "train"), os.path.join(args.gt, "train"),
        patch_size = args.patch_size, transform = transform
    )
    val_set = SegDataset_Val(
        os.path.join(args.cassini, "val"), os.path.join(args.gt, "val"),
        transform = transform
    )
