...
def argparser():
    ...
    # segment params
    parser.add_argument("--model_dir", type=str, default="model_weights/seg/seg_epure/final.ckpt")
    ...
    # plot 
    parser.add_argument("--fig_savedir", type=str, default="fig_results_test/seg/evaluation_epure_GN2_denoise")
    parser.add_argument("--log_dir", type=str, default="logs/seg/Cassini_seg_epure_GN2_denoise.txt")
